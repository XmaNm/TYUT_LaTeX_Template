...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%	太原理工大学博士论文 XeLaTeX 模版 —— 封面文件 cover.tex
%	版本：0.71
%	最后更新：2010.12.22
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cdegree{博~~士~~学~~位~~论~~文}
\ctitle{论文题目：\underline{博士论文题目.The title of doctoral disseration.} }
\etitle{英文题目：\underline{博士论文题目.The title of doctoral disseration.} }

% 根据需要添加字符间距
\csubject{{\quad\;}计~算~机~应~用~技~术}
\cauthor{{\quad\;}张~~　~~三}
\cauthorno{{\quad\;}2000310001}
\csupervisor{{\quad\;}李~~ ~~四　教授}

% 这里默认使用最后编译的时间，也可自行给定日期，注意汉字和数字之间的空格。
\cdate{{\quad\;}\the\year~年~\the\month~月~\the\day~日}

\cabstract{
本模版是根据太原理工大学博士学位论文格式规范制作的~\LaTeX~博士学位论文模板。

本模板是基于大连理工大学等高校的硕博士论文模板，
并按照太原理工大学博士学位论文格式规范开发的~\LaTeX~论文模板，
...
本模板的目的旨在推广~\LaTeX~这一优秀的排版软件在太理（尤其是计算机相关专业）的应用，
...
\eabstract{
This is a \LaTeX{} template of doctor degree thesis of Taiyuan University of Technology,
